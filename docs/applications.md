...
The [completeness regressions](../AlgebraicTests/Completeness.lean) also check
...
The [Core-only translation example](../AlgebraicTests/CoreTranslation.lean)
...
[restriction regressions](../AlgebraicTests/Restriction.lean) check these cases,
...
[Hessian example](../AlgebraicTests/Hessian.lean) computes the matrix
...
[Waring examples](../AlgebraicTests/Waring.lean) derive the four-variable
...
bound; see the [source module](../Algebraic/LowerBound/Fusion/SumOfTerms/Waring.lean)
