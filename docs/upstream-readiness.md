...
The library pins CSLib to `85805b8447124a6561a5751d8b488f8fae96699e` and Lean
`v4.34.0-rc2`. A live check on 2026-09-15 found:

- CSLib main at `91ab23c78b12e6c9d6fe747fa3f55c2771dd376e`.
- [Lupanov PR #890](https://github.com/leanprover/cslib/pull/890) open at
  `e5d337193a42a436bd1a255edafc25253d81314d`.
- [Shannon PR #891](https://github.com/leanprover/cslib/pull/891) open at
  `fa41ecebd01220ed4ba4b57b4968bb7f9d9c06ef`, stacked on #890.

These are a dated snapshot, not a claim about the eventual submission base.
The pinned dependency has not been updated during this preparation step.
