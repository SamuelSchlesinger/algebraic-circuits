...
and asymptotic first-contact bounds are included. Encoder and decoder bounds,
XOR transport, exact geometric approximation error, neighborhood counting,
minimal nonfaces, and Alexander duality for link homology over F2 are included.
-/
