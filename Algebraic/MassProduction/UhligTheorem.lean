...
The logarithmic parameter choice and finite recursive theorem live in focused
supporting modules. This module proves the arithmetic and eventual bounds that
yield the sharp asymptotic theorem, parameterized by a sharp one-copy synthesis
family. The separate Lupanov module discharges that premise.
-/
