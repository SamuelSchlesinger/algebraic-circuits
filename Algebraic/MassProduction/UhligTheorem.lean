...
The logarithmic parameter choice and its one-layer polynomial estimate live in
`UhligParameters`. This module starts from the finite recursive construction
and proves the sharp asymptotic theorem, parameterized by a sharp one-copy
synthesis family. The separate Lupanov module discharges that premise.
-/
