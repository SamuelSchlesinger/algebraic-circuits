...
/-!
# Uhlig decoder and finite mass-production layer

Building on the semantic routing and resource-bank construction in
`UhligRoutingCircuit`, this module assembles the decoder and the complete
finite mass-production layer used by the quantitative Uhlig recursion.
